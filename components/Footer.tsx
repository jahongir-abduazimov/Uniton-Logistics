...
import { FaTelegramPlane, FaWhatsapp, FaWeixin } from "react-icons/fa";
...
export const Footer: React.FC<FooterProps> = ({ translations }) => {
  ...
  return (
    <footer
      id="footer"
      className="relative bg-linear-to-br from-[#074C6E] via-[#085f87] to-[#063d57] text-white py-16 px-4 md:px-6 lg:px-8 overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-12">
          ...
          <div>
            <h4 className="font-bold text-lg mb-6 pb-2 border-b border-white/20 flex items-center gap-2">
              <Navigation size={18} />
              {translations.locale === "en" ? "Menu" : "Меню"}
            </h4>
